  ...
  return (
    <div className="flex xl:flex-row flex-col w-auto  xl:w-[1182px] mx-auto justify-between items-center gap-[85px]">
      <div className="md:w-[510px] w-full  relative h-[456px] shrink-0">
        <div className="lg:w-[222px] lg:h-[222px] w-[146px] h-[146px] absolute top-0 left-[32px] shrink-0">
          <img src={man1} alt="" className='h-full w-full  rounded-[30px] object-cover' />
        </div>

        <div className='lg:w-[261px] w-[166px] h-[176px] lg:h-[198px] lg:left-[0px] left-[5px] absolute bottom-0'>
          <img src={man2} className='h-full w-full object-cover rounded-[30px]' alt="" />
        </div>

        <div className='lg:w-[221px] w-[146px] h-[193px] lg:h-[263px] lg:right-[0px] right-[5px] absolute right-0 top-[50%] -translate-y-1/2 ' >
          <img className='h-full w-full object-cover rounded-[30px]' src={man3} alt="" />
        </div>
      </div>
